...
document.addEventListener("DOMContentLoaded", () => {
  ...
  dashboard.insertAdjacentHTML("beforeend", `
    <section id="settingsPage" class="settings-page app-page hidden" aria-labelledby="settingsTitle">
      ...
      <div class="settings-layout">
        ...
        <section class="settings-card" aria-labelledby="appSettingsTitle">
          ...
          <div class="app-status-list">
            ...
            <div><span><i class="fa-solid fa-code-branch"></i><strong>Installierte Version</strong></span><em>Version 1.0.1 · 0018</em></div>
          </div>
      ...
      <section class="settings-about"><span><i class="fa-solid fa-fingerprint"></i></span><div><strong>TimeFlow PWA</strong><p>Sprint 12 · Version 1.0.1 · Build 0018</p></div><em>Made for better workdays</em></section>
