...
if (!document.querySelector('script[data-beta-access]')) {
  const accessStyle = document.createElement("link"); accessStyle.rel = "stylesheet"; accessStyle.href = "css/private-beta-access.css?v=0040-invite2"; document.head.append(accessStyle);
  const accessScript = document.createElement("script"); accessScript.src = "js/private-beta-access.js?v=0040-invite2"; accessScript.dataset.betaAccess = "true"; document.head.append(accessScript);
}
