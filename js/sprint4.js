    ...
    <section id="profilePage" class="profile-page app-page hidden" aria-labelledby="profileTitle">
      ...
      <section class="profile-details-grid">
        ...
        <article class="profile-menu-card">
          ...
          <div class="version-row"><span class="menu-icon version"><i class="fa-solid fa-mobile-screen"></i></span><span><strong>TimeFlow PWA</strong><small>Alpha 1.0 · Build 0016</small></span><em>Stabil</em></div>
        </article>
      </section>
