...
const APP_SHELL = [
  ...
  "js/branding-splash.js?v=__TIMEFLOW_BUILD__", "js/platform.js?v=__TIMEFLOW_BUILD__", "js/shell.js?v=__TIMEFLOW_BUILD__", "js/script.js?v=__TIMEFLOW_BUILD__", "js/sprint3.js?v=__TIMEFLOW_BUILD__", "js/sprint4.js?v=__TIMEFLOW_BUILD__", "js/sprint5.js?v=__TIMEFLOW_BUILD__", "js/sprint6.js?v=__TIMEFLOW_BUILD__", "js/sprint7.js?v=__TIMEFLOW_BUILD__", "js/sprint8.js?v=__TIMEFLOW_BUILD__", "js/sprint9.js?v=__TIMEFLOW_BUILD__", "js/sprint10.js?v=__TIMEFLOW_BUILD__", "js/sprint11.js?v=__TIMEFLOW_BUILD__", "js/sprint12.js?v=__TIMEFLOW_BUILD__", "js/stamp.js?v=__TIMEFLOW_BUILD__", "js/private-home.js?v=__TIMEFLOW_BUILD__", "js/private-schedule-import.js?v=__TIMEFLOW_BUILD__", "js/private-clean.js?v=__TIMEFLOW_BUILD__", "js/private-account.js?v=__TIMEFLOW_BUILD__", "js/work-protection.js?v=__TIMEFLOW_BUILD__", "js/settings-organization.js?v=__TIMEFLOW_BUILD__", "js/support-feedback.js?v=__TIMEFLOW_BUILD__", "js/ui-localization.js?v=__TIMEFLOW_BUILD__", "js/private-reminders.js?v=__TIMEFLOW_BUILD__", "js/private-beta-legal.js?v=__TIMEFLOW_BUILD__", "js/private-beta-access.js?v=__TIMEFLOW_BUILD__", "js/private-beta-personalization.js?v=__TIMEFLOW_BUILD__",
