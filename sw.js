...
const APP_SHELL = [
  ...
  "css/style.css?v=__TIMEFLOW_BUILD__", "css/pwa.css?v=__TIMEFLOW_BUILD__", "css/sprint3.css?v=__TIMEFLOW_BUILD__", "css/sprint4.css?v=__TIMEFLOW_BUILD__", "css/sprint5.css?v=__TIMEFLOW_BUILD__", "css/sprint6.css?v=__TIMEFLOW_BUILD__", "css/sprint7.css?v=__TIMEFLOW_BUILD__", "css/sprint8.css?v=__TIMEFLOW_BUILD__", "css/sprint9.css?v=__TIMEFLOW_BUILD__", "css/sprint10.css?v=__TIMEFLOW_BUILD__", "css/sprint11.css?v=__TIMEFLOW_BUILD__", "css/sprint12.css?v=__TIMEFLOW_BUILD__", "css/stamp.css?v=__TIMEFLOW_BUILD__", "css/compat.css?v=__TIMEFLOW_BUILD__", "css/private-home.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-import.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-saved.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-corrections.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-learning.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-private-view.css?v=__TIMEFLOW_BUILD__", "css/private-schedule-manual.css?v=__TIMEFLOW_BUILD__", "css/private-notifications.css?v=__TIMEFLOW_BUILD__", "css/private-clean.css?v=__TIMEFLOW_BUILD__", "css/private-account.css?v=__TIMEFLOW_BUILD__", "css/private-beta-access.css?v=__TIMEFLOW_BUILD__", "css/theme-personalization.css?v=__TIMEFLOW_BUILD__", "css/personalization-options.css?v=__TIMEFLOW_BUILD__", "css/font-language-options.css?v=__TIMEFLOW_BUILD__", "css/adaptive-ui-fixes.css?v=__TIMEFLOW_BUILD__", "css/support-feedback.css?v=__TIMEFLOW_BUILD__", "css/settings-organization.css?v=__TIMEFLOW_BUILD__", "css/device-safe-layout.css?v=__TIMEFLOW_BUILD__", "css/unified-glass.css?v=__TIMEFLOW_BUILD__", "css/private-beta-personalization.css?v=__TIMEFLOW_BUILD__",
  "js/work-time-api.js?v=__TIMEFLOW_BUILD__", "js/branding-splash.js?v=__TIMEFLOW_BUILD__", "js/platform.js?v=__TIMEFLOW_BUILD__", "js/shell.js?v=__TIMEFLOW_BUILD__", "js/script.js?v=__TIMEFLOW_BUILD__", "js/sprint3.js?v=__TIMEFLOW_BUILD__", "js/sprint4.js?v=__TIMEFLOW_BUILD__", "js/sprint5.js?v=__TIMEFLOW_BUILD__", "js/sprint6.js?v=__TIMEFLOW_BUILD__", "js/sprint7.js?v=__TIMEFLOW_BUILD__", "js/sprint8.js?v=__TIMEFLOW_BUILD__", "js/sync-conflict.js?v=__TIMEFLOW_BUILD__", "js/sprint9.js?v=__TIMEFLOW_BUILD__", "js/sprint10.js?v=__TIMEFLOW_BUILD__", "js/sprint11.js?v=__TIMEFLOW_BUILD__", "js/sprint12.js?v=__TIMEFLOW_BUILD__", "js/stamp.js?v=__TIMEFLOW_BUILD__", "js/private-home.js?v=__TIMEFLOW_BUILD__", "js/private-schedule-import.js?v=__TIMEFLOW_BUILD__", "js/private-clean.js?v=__TIMEFLOW_BUILD__", "js/private-account.js?v=__TIMEFLOW_BUILD__", "js/work-protection.js?v=__TIMEFLOW_BUILD__", "js/settings-organization.js?v=__TIMEFLOW_BUILD__", "js/support-feedback.js?v=__TIMEFLOW_BUILD__", "js/ui-localization.js?v=__TIMEFLOW_BUILD__", "js/private-reminders.js?v=__TIMEFLOW_BUILD__", "js/private-beta-legal.js?v=__TIMEFLOW_BUILD__", "js/private-beta-access.js?v=__TIMEFLOW_BUILD__", "js/private-beta-personalization.js?v=__TIMEFLOW_BUILD__",
  "vendor/tesseract/tesseract.esm.min.js", "vendor/tesseract/worker.min.js", "vendor/tesseract/core/tesseract-core-lstm.wasm.js", "vendor/tesseract/core/tesseract-core-simd-lstm.wasm.js", "vendor/tesseract/core/tesseract-core-lstm.wasm", "vendor/tesseract/core/tesseract-core-simd-lstm.wasm", "vendor/tesseract/lang/4.0.0/deu.traineddata.gz",
  "assets/branding/timeflow-phoenix-mark-v1.png", "assets/icons/timeflow-phoenix-icon-192.png", "assets/icons/timeflow-phoenix-icon-512.png", "assets/icons/timeflow-phoenix-maskable-512.png"
];
