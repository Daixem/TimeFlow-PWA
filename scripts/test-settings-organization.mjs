...
for (const marker of ["Support & Feedback", "Letzter Einsatz", "Nächster Einsatz", "Arbeits- & Jugendschutz", "MutationObserver", 'lang.startsWith("ar")', "aria-description", "input[type=submit]", "timeflow:language-changed", "replaceAll", "isKnownRendering", "function locale()", "toLocaleDateString", "toLocaleTimeString", '"Guten Abend":"Good evening"', '"Mein eigener Dienstplan":"My personal schedule"', '"Was möchtest du öffnen?":"What would you like to open?"', '"Mittwoch":"Wednesday"']) if (!localization.includes(marker)) throw new Error(`Vollständige UI-Lokalisierung fehlt: ${marker}`);
