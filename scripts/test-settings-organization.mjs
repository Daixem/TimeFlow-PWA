...
for (const marker of ["css/settings-organization.css?v=0040-settings2", "js/settings-organization.js?v=0040-settings3", "css/adaptive-ui-fixes.css?v=0040-adaptive1", "js/ui-localization.js?v=0040-i18n3", "sw.js?v=0040-beta12"]) if (!index.includes(marker)) throw new Error(`Asset fehlt: ${marker}`);
