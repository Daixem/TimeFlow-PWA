...
for (const marker of ["private-beta-personalization.css?v=0040-beta1", "private-beta-personalization.js?v=0040-beta1", "sw.js?v=0040-beta3"]) if (!index.includes(marker)) throw new Error(`Beta-Erweiterung fehlt: ${marker}`);
