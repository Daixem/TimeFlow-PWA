...
for (const marker of ["private-beta-personalization.css?v=0040-beta2", "private-beta-personalization.js?v=0040-beta4", "sw.js?v=0040-beta12"]) if (!index.includes(marker)) throw new Error(`Beta-Erweiterung fehlt: ${marker}`);
