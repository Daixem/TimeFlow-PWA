...
for (const marker of ["private-beta-personalization.css?v=0040-beta2", "private-beta-personalization.js?v=0040-beta5", "sw.js?v=0040-beta19"]) if (!index.includes(marker)) throw new Error(`Beta-Erweiterung fehlt: ${marker}`);
...
for (const marker of ["css/theme-personalization.css?v=0040-theme2", "js/work-protection.js?v=0040-legal2", "js/sprint4.js?v=0040-profile2"]) if (!index.includes(marker) || !serviceWorker.includes(marker)) throw new Error(`Neues Profil-Asset fehlt: ${marker}`);
