...
for (const marker of ["timeflow-private-account-v1", "captureCompletedWorkday", "Guthaben hinzufügen", "Stunden abziehen", "data-delete-account", "timeflow:open-private-account"]) {
