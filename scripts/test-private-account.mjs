...
for (const marker of ["timeflow-private-account-v1", "captureCompletedWorkday", "monthlyValues", "renderHomeMonth", "TimeFlowPrivateAccount", "Guthaben hinzufügen", "Stunden abziehen", "data-delete-account", "timeflow:open-private-account", "monthlyTargetHours", "MONATSSOLL", "stamped + manual - target", "Math.max(0, values.balance)"]) {
