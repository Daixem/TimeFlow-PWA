...
if (index.indexOf("js/platform.js?v=0022") < 0 || index.indexOf("js/platform.js?v=0022") > index.indexOf("js/script.js?v=0022")) {
  throw new Error("Die Plattformbasis wird nicht vor den Funktionsskripten geladen.");
}
for (const asset of ["js/platform.js?v=0022", "css/compat.css?v=0022"]) {
