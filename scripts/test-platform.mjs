...
if (index.indexOf("js/platform.js?v=0028") < 0 || index.indexOf("js/platform.js?v=0028") > index.indexOf("js/script.js?v=0028")) {
  throw new Error("Die Plattformbasis wird nicht vor den Funktionsskripten geladen.");
}
for (const asset of ["js/platform.js?v=0028", "css/compat.css?v=0028"]) {
