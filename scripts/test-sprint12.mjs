...
const requiredSnippets = new Map([
  ["index.html", ["css/compat.css?v=0040", "css/sprint12.css?v=0040", "css/private-home.css?v=0040-home2", "js/platform.js?v=0040", "js/shell.js?v=0040", "js/sprint12.js?v=0040", "js/private-home.js?v=0040-home18", "sw.js?v=0040-beta4", "personal-update-list", "data-personal-message", "team-update-list", "team-update-status", "month-open-statistics", "homeMonthLabel"]],
  ["sw.js", ["timeflow-v61-beta-testers", "relativePath.startsWith(\"api/\")", "response.type === \"opaque\"", "js/platform.js?v=0040", "js/shell.js?v=0040", "css/compat.css?v=0040", "js/sprint12.js?v=0040", "js/private-home.js?v=0040-home18", "js/private-schedule-import.js?v=0040-beta4"]],
