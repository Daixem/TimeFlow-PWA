...
const requiredSnippets = new Map([
  ...
  ["sw.js", ["timeflow-v65-private-beta-ready", "relativePath.startsWith(\"api/\")", "response.type === \"opaque\"", "js/platform.js?v=0040", "js/shell.js?v=0040", "css/compat.css?v=0040", "js/sprint12.js?v=0040", "js/private-home.js?v=0040-home19", "js/private-schedule-import.js?v=0040-invite1"]],
