...
const requiredSnippets = new Map([
  ["index.html", ["css/compat.css?v=0029", "css/sprint12.css?v=0029", "js/platform.js?v=0029", "js/shell.js?v=0029", "js/sprint12.js?v=0029", "sw.js?v=0029", "personal-update-list", "data-personal-message", "team-update-list", "team-update-status"]],
  ["sw.js", ["timeflow-v30", "relativePath.startsWith(\"api/\")", "response.type === \"opaque\"", "js/platform.js?v=0029", "js/shell.js?v=0029", "css/compat.css?v=0029", "js/sprint12.js?v=0029"]],
  ...
  ["js/sprint12.js", ["Geräte- und PWA-Check", "timeflow-device-check-v1", "Sichere Ausführung", "Mobile Darstellung", "Datensicherung", "timeflow:device-resumed", "function enforcePageState", "dataset.timeflowPage", "homeDetailDialog", "action: null, event: \"info\"", "Im Chat gratulieren", "timeflow:open-mode-selection", "is-actionable"]],
...
if (home.status !== 200 || !(await home.text()).includes("js/platform.js?v=0029")) {
