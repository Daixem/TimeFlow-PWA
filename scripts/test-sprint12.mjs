...
const requiredSnippets = new Map([
  ["index.html", ["css/compat.css?v=0040-mobile2", "css/sprint12.css?v=0040-mobile2", "css/private-home.css?v=0040-home2", "js/platform.js?v=0040", "js/shell.js?v=0040-scroll1", "js/sprint12.js?v=0040-scroll1", "js/private-home.js?v=0040-home19", "sw.js?v=0040-beta9", "personal-update-list", "data-personal-message", "team-update-list", "team-update-status", "month-open-statistics", "homeMonthLabel"]],
  ["sw.js", ["timeflow-v74-settings-catalog", "relativePath.startsWith(\"api/\")", "response.type === \"opaque\"", "js/platform.js?v=0040", "js/shell.js?v=0040-scroll1", "css/compat.css?v=0040-mobile2", "js/sprint12.js?v=0040-scroll1", "js/private-home.js?v=0040-home19", "js/private-schedule-import.js?v=0040-files2"]],
